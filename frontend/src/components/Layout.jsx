      ...
      <header className="bg-nublia-accent text-gray-800 px-6 py-4 flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          <div className="text-right">
            ...
            <button
              onClick={sair}
              className="mt-2 bg-nublia-orange text-nublia-accent px-4 py-1 text-sm rounded-full flex items-center gap-2 hover:text-nublia-primary hover:bg:nublia-orangepink ml-auto"
            >
